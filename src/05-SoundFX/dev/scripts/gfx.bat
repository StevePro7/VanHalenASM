...
::bmp2tile.exe raw\sprite.bmp -savetiles "sprite (tiles).psgcompr" -removedupes -planar -tileoffset 0 -savepalette "sprite (palette).bin" -fullpalette  -spritepalette -exit
